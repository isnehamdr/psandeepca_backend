...
const emptyForm = {
	...
	short_description: '',
	image: null,
	is_active: 'true', // string, to match radio values
};
...
const AddHero = ({
	...
	const handleCreate = async (formData) => {
		try {
			...
			console.log('Error creating hero', error?.response?.data || error);
			throw error;
		}
	};
	...
	const onSubmit = async (data) => {
		...
		// data.is_active is the string 'true' or 'false' from the radio group
