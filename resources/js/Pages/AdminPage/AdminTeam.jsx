...
// // Safely resolve an image path against VITE_IMAGE_PATH.
// // Handles absolute URLs, missing/trailing slashes, and missing values.
...
// 							className="text-indigo-600 hover:text-indigo-800 text-sm underline truncate max-w-[160px] inline-block"
// 							title={value}
// 						>
// 							{value}
// 						</a>
...
// 						);
// 					} catch {
// 						return <span className="text-gray-400">Invalid time</span>;
// 					}
// 				},
// 			},
// 			{
...
// 									<img
// 										src={getImageUrl(viewingTeam.person_image)}
// 										alt={viewingTeam.name || 'Team member'}
...
// 							<div>
// 								<h3 className="text-2xl font-bold text-gray-900">{viewingTeam.name || 'N/A'}</h3>
// 								<p className="text-gray-600">{viewingTeam.title || 'N/A'}</p>
// 							</div>

// 							{viewingTeam.social_link && (
// 								<a
// 									href={viewingTeam.social_link}
// 									target="_blank"
// 									rel="noopener noreferrer"
// 									className="inline-block text-indigo-600 hover:text-indigo-800 text-sm underline break-all"
// 								>
// 									{viewingTeam.social_link}
// 								</a>
// 							)}
...
const SocialLinks = ({ team, className = '' }) => {
	const links = [
		{ key: 'instagram_link', url: team.instagram_link, Icon: TiSocialInstagramCircular, label: 'InstagramIc' },
		{ key: 'facebook_link', url: team.facebook_link, Icon: TiSocialFacebookCircular, label: 'Facebook' },
		{ key: 'linkedin_link', url: team.linkedin_link, Icon: TiSocialLinkedinCircular, label: 'LinkedIn' },
	].filter((link) => link.url);

	if (links.length === 0) {
		return <span className="text-gray-400 text-xs">No links</span>;
	}
	...
	const columns = useMemo(
		() => [
			...
			},
			{
				Header: 'Social Links',
				id: 'social_links',
				Cell: ({ row }) => <SocialLinks team={row.original} />,
			},
			{
				Header: 'Status',
				accessor: 'is_active',
				...
				<div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
					<div className="bg-white rounded-xl max-w-lg w-full p-6 shadow-xl max-h-[90vh] overflow-y-auto">
						...
						<div className="space-y-6">
							...
							<SocialLinks team={viewingTeam} className="gap-4" />
